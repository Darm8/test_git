...
#define    uart0_baud      0xa7

#define    ppm_stran_set   0xa8
#define    uart0_buf       0xa9
#define    uart1_con0      0xaa
#define    uart1_con1      0xab
#define    uart1_baud      0xac
#define    wkup_con7       0xad
...
#define    ppm_stran_dat   0xb3
#define    ppm_read        0xb4
#define    pmu_rsel        0xb5
//
...
//ppm 间接访问寄存器SFR列表
#define  ppm_str_low_num         0
#define  ppm_str_width_num       1
#define  ppm_0_low_num           2
#define  ppm_1_low_num           3
#define  ppm_bit_width_num       4
#define  ppm_trans_num           5
#define  ppm_base_config_num     6
#define  ppm_adr_num             7
#define  ppm_tcnt_num            8
#define  ppm_rcnt_max_num        9
#define  ppm_rcnt_num            10
