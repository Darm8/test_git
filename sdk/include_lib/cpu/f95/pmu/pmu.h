...
#define sfr_rd_sel0             [pmu_octl].6
#define sfr_rd_sel1             [pmu_octl].7
#define sfr_rd_sel2             [wkup_con4].7
#define wkup6_sel_vcc_vbat_cmp()  wkup6_sel1 = 1 %% wkup6_sel0 = 0
#define wkup6_disable()
...
#define pmu_sel_rd_page(n) \
    sfr_rd_sel2 = ((n>>2) & 1) %% sfr_rd_sel1 =((n>>1) & 1) %% sfr_rd_sel0 = (n & 1)
...
#define boost_gm_tsel1          [ana_con1].1
...
#define vbat_ok_en              [ana_con10].1
#define vbat_div_en             [ana_con10].0
#define vout0_is_s3             [ana_con11].7
...
#define vout1_is_s3             [ana_con13].7
...
#define vout_sense_sel          [ana_con16].0
#define vcc_uv_ref_s1           [ana_con17].7
#define vcc_uv_ref_s0           [ana_con17].6
#define vcc_uv_en               [ana_con17].5
#define vcc_ov_en               [ana_con17].4
#define out_is_vs3              [ana_con17].3
#define out_is_vs2              [ana_con17].2
#define out_is_vs1              [ana_con17].1
#define out_is_vs0              [ana_con17].0
...
#define wkup6_eie               [wkup_con2].7
#define wkup6_lie               [wkup_con2].6
#define wkup6_sel1              [wkup_con2].5
#define wkup6_sel0              [wkup_con2].4
#define wkup5_eie               [wkup_con2].3
#define wkup4_eie               [wkup_con2].2
#define wkup3_eie               [wkup_con2].1
#define wkup2_eie               [wkup_con2].0

#define wkup6_inv               [wkup_con3].7
#define wkup7_flt_sel2          [wkup_con3].6
#define wkup7_flt_sel1          [wkup_con3].5
#define wkup7_flt_sel0          [wkup_con3].4
#define wkup7_eie               [wkup_con3].3
#define wkup7_lie               [wkup_con3].2
#define wkup7_inv               [wkup_con3].1
#define wkup7_en                [wkup_con3].0

//#define sfr_rd_sel2             [wkup_con4].7
#define wkup8_flt_sel2          [wkup_con4].6
#define wkup8_flt_sel1          [wkup_con4].5
#define wkup8_flt_sel0          [wkup_con4].4
#define wkup8_eie               [wkup_con4].3
#define wkup8_lie               [wkup_con4].2
#define wkup8_inv               [wkup_con4].1
#define wkup8_en                [wkup_con4].0

#define wkup9_flt_sel2          [wkup_con5].6
#define wkup9_flt_sel1          [wkup_con5].5
#define wkup9_flt_sel0          [wkup_con5].4
#define wkup9_eie               [wkup_con5].3
#define wkup9_lie               [wkup_con5].2
#define wkup9_inv               [wkup_con5].1
#define wkup9_en                [wkup_con5].0

#define wkup10_flt_sel2         [wkup_con6].6
#define wkup10_flt_sel1         [wkup_con6].5
#define wkup10_flt_sel0         [wkup_con6].4
#define wkup10_eie              [wkup_con6].3
#define wkup10_lie              [wkup_con6].2
#define wkup10_inv              [wkup_con6].1
#define wkup10_en               [wkup_con6].0
...
#define vbat_ok_pg1             [pmu_read].5  //sfr_rd_sel = 0b001
...
#define out_is_comp             [pmu_read].4  //sfr_rd_sel = 0b011
...
#define wk8_edge_vout_det_pnd_pg7             [pmu_read].0  //sfr_rd_sel = 0b111
...
#define vout2vbat_open()      \
        chg_bg_en = 1       %%\
        delay_ms(1)         %%\
        tstchg_en = 1 %% chg_buck_en = 0 %% chg_line_en = 1

#define pmu_chg_api()    \
        chg_civol_s2   = 1 %% chg_civol_s1   = 0 %% chg_civol_s0   = 0  %%\
        chg_ifull_s2   = 1 %% chg_ifull_s1   = 1 %% chg_ifull_s0   = 1

#define wkup9_sel_vout0()
