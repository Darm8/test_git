...
#define data_is_zero_skip(d)    w = d %% w -= 0 %% if(ALU_IS_ZERO) skip
#define data_not_zero_skip(d)   w = d %% w -= 0 %% if(ALU_NOT_ZERO) skip

#define dk_is_zero_skip(d,k)    w = k %% w = d - w %% if(ALU_IS_ZERO) skip
#define dk_not_zero_skip(d,k)   w = k %% w = d - w %% if(ALU_NOT_ZERO) skip

#define dw_is_equ_skip(d)       w = d - w %% if(EQU_ALU) skip
#define dw_not_equ_skip(d)      w = d - w %% if(NOT_EQU_ALU) skip
...
#define a_evt_1s       [a_sys_event_1].1    //充电仓电池满电标记，没有被库使用到
#define a_evt_vbat_lowpower   [a_sys_event_1].2    //充电仓低电事件，没有被库使用到
#define a_bit_bg_1_8          [a_sys_event_1].3    //外部LDO做为参考运算ADC结果，没有被库调用到
...
// #define a_ear_fail_cnt        25
#define a_tmr_1s_cnt        25
...
#define a_vbat_chg_cnt     33           //iir滤波变量，库没有直接使用到
...
#define a_led0_duty         49
#define a_led1_duty         50
#define a_led2_duty         51


#define a_ppm_buf          a_chg_buf //库变量，不可变动
...
#define b_disable_vout0      [a_pmu_status0].7
 ...
 **********************************************************/
#define a_keep_ram         71
#define a_keep_chg_bit     71
// #define a_chg_iline_s0   [a_chg_bit].5
// #define a_chg_iline_s1   [a_chg_bit].6
// #define a_chg_iline_s2   [a_chg_bit].7
#define a_keep_1_2ms       72
#define a_keep_trim_bg     73
#define a_ut_9600_baud_h   74
#define a_ut_9600_baud_l   75
#define a_vbg_vol_h        76
#define a_vbg_vol_l        77
#define a_src_clk_h        78
#define a_src_clk_l        79
#define sys_stack          80
